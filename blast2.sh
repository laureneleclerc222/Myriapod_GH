#!/bin/bash
#SBATCH --job-name=blast_array_GH5_2
...
OUTPUT="/scratch/pawsey1193/lleclerc/CUHK_new/trees/blast_outputs/${GH}/${SAMPLE}_vs_aa2.blast.tsv"
...
awk '{gsub(/ /, "_"); print}' /scratch/pawsey1193/lleclerc/CUHK_new/trees/blast_outputs/"$GH"/"$SAMPLE"_vs_aa2.blast.tsv > /scratch/pawsey1193/lleclerc/CUHK_new/trees/blast_outputs/"$GH"/"$SAMPLE"_vs_aa2_.blast.tsv

#turn into fasta file
awk 'BEGIN { OFS = "\n" } { print ">"$11"_"$4"_"$12, $3 }' /scratch/pawsey1193/lleclerc/CUHK_new/trees/blast_outputs/"$GH"/"$SAMPLE"_vs_aa2_.blast.tsv > /scratch/pawsey1193/lleclerc/CUHK_new/trees/blast_outputs/"$GH"/"$SAMPLE"_vs_aa2.fasta
